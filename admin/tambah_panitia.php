...
<form action="controller.php?page=panitia&action=insert" id="form_proposal" enctype="multipart/form-data" method="post">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="mbr-section col-md-12 col-lg-offset-4 col-lg-8 col-xl-offset-0 col-xl-12" id="ringkasan" style="padding-bottom: 0px !important;">
                        <h4 class="mbr-section-title display-3">TAMBAH PANITIA</h4>
                            ...
                            <div class='row'>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        Nama Panitia
                                        <input type="text" class="form-control" name="nama" placeholder="nama Panitia.." required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jabatan" required>
                                            ...
                                            ?>
                                            <option value="<?php echo $df['nama_jabatan'] ?>"><?php echo $df['nama_jabatan'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
