...
<form action="controller.php?page=pengeluaran_panitia&action=insert" id="form_proposal" enctype="multipart/form-data" method="post">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="mbr-section col-md-12 col-lg-offset-4 col-lg-8 col-xl-offset-0 col-xl-12" id="ringkasan" style="padding-bottom: 0px !important;">
                        <h4 class="mbr-section-title display-3">TAMBAH PENGELUARAN PANITIA</h4>
                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        Tanggal
                                        <input type="date" class="form-control tanggal" name="tgl" placeholder="Tanggal.." data-link-format="yyyy-mm-dd" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mbr-section-text">
                            <div class='row'>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        Jumlah
                                        <input type="number" onkeypress="return onlyNumbers();" class="form-control" name="jumlah" placeholder="Jumlah.." required min="0">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        Harga Satuan
                                        <input type="number" onkeypress="return onlyNumbers();" class="form-control" name="harga_satuan" placeholder="Harga Satuan.." required min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
